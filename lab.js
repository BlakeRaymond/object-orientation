...
favoriteThings.car = "Nissan R35"
favoriteThings.show = "Severance"
...
console.log(greeting({title: 'Mr.', firstName: 'Blake', lastName: 'Raymond'}))
...
totalPopulation({utah: 8, california: 5, texas: 11, arizona: 10})
//////////////////////////// PROBLEM 9 ////////////////////////////
...
console.log(ingredients(macroObj))
...
let cat1 = new Cat('Garfield', 4, 'orange')
let cat2 = new Cat('Kosmo', 2, 'black')
...
let wizard1 = new Wizard("Billy", 420, "Minoletta's Concussive Missiles")
console.log(wizard1)
...
let phone1 = new Phone ("Apple", "iPhone", "64GB", "Rose Gold", "$1,000")
let phone2 = new Phone ("Samsung", "Galaxy", "32GB", "Black", "$780")
let phone3 = new Phone ("LG", "Note", "128GB", "Blue", "$1,200")
